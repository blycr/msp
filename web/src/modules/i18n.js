...
const I18N = {
  en: {
    ...
    hint_noshare_local: "Unconfigured. Click 'Settings' to add shares.",
    hint_noshare_remote: "Unconfigured. Please contact the administrator to add shares.",
    ...
    playlist: "Playlist",
    pl_collapse: "Collapse playlist",
    pl_show: "Playlist",
    not_loaded: "Not Loaded",
    playlist_empty: "Play something to build a queue.",
    footer_text: "A simple media server for personal use.",
    footer_self_hosted: "Self-hosted",
    mobile_view_label: "Mobile view",
    mobile_preview: "Preview",
    mobile_queue: "Playlist",
    mobile_files: "Files",
    empty_library_title: "Your library is ready when you are.",
    empty_search_title: "No matching files",
    empty_search_hint: "Try a different name, type, or search term.",
    open_settings: "Open Settings",
    favorite_add: "Add to favorites",
    favorite_remove: "Remove from favorites",
    dlg_title: "Share Settings",
    share_settings: "Folders",
    path_ph: "e.g. D:\\Media",
  ...
  zh: {
    ...
    hint_noshare_local: '未配置共享目录。点击右上角"共享目录设置"添加。',
    hint_noshare_remote: "未配置共享目录，请联系管理员添加。",
    preview_none: "未选择",
    prev: "上一个",
    next: "下一个",
    shuffle: "随机",
    ...
    pl_show: "播放列表",
    not_loaded: "未加载",
    playlist_empty: "播放媒体后，队列会显示在这里。",
    footer_text: "一个适合个人使用的简易媒体服务器。",
    footer_self_hosted: "自托管",
    mobile_view_label: "移动端视图",
    mobile_preview: "预览",
    mobile_queue: "播放列表",
    mobile_files: "文件",
    empty_library_title: "媒体库已准备就绪",
    empty_search_title: "没有匹配的文件",
    empty_search_hint: "换个名称、类型或搜索关键词试试。",
    open_settings: "打开设置",
    favorite_add: "加入收藏",
